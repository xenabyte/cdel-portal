...
class Controller extends BaseController
{
    ...
    public function checkSchoolFees($student, $academicSession, $levelId){
        ...
        $studentPendingTransactions = Transaction::with('paymentType')->where('student_id', $studentId)->where('payment_id', $schoolPaymentId)->where('status', null)->where('payment_method', null)->get();
