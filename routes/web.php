...
Route::group(['middleware' => GlobalDataMiddleware::class, 'prefix' => 'admin'], function () {
  ...
  Route::get('students', [App\Http\Controllers\Admin\AdmissionController::class, 'students'])->name('students');
  Route::get('student/{slug}', [App\Http\Controllers\Admin\AdmissionController::class, 'student'])->name('student');
...
Route::group(['middleware' => GlobalDataMiddleware::class, 'prefix' => 'staff'], function () {
  ...
  Route::get('/home', [App\Http\Controllers\Staff\StaffController::class, 'index'])->name('home');
});
...
Route::group(['middleware' => GlobalDataMiddleware::class, 'prefix' => 'guardian'], function () {
  ...
  Route::get('/home', [App\Http\Controllers\Guardian\GuardianController::class, 'index'])->name('home');
});
