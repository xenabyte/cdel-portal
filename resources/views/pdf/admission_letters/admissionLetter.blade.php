    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <ul>
                ...
                <li>Prepare for resumption. Please note that the resumption date for {{ $programmeCategory->academicSessionSetting->admission_session }} Academic Session is <strong>{{ date('l, jS F, Y', strtotime($programmeCategory->academicSessionSetting->resumption_date)) }}. Note that any Fees paid is non-refundable.</strong></li>
