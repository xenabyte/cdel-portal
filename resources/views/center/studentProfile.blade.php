                ...
                <div class="row">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if($transaction->status == 1)
                                                                        <form action="{{ url('/center/generateInvoice') }}" method="post" enctype="multipart/form-data">
                                                                            @csrf
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            @if(!empty($student->applicant->center))
                                        ...
                                        <table class="table mb-0 table-borderless">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ $student->applicant->center->name }}</td>
                                                </tr>
                                                <tr>
                                                    <th><span class="fw-medium">Email</span></th>
                                                    <td>{{ $student->applicant->center->email }}</td>
                                                </tr>
                                                <tr>
                                                    <th><span class="fw-medium">Contact No.</span></th>
                                                    <td>{{ $student->applicant->center->phone_number }}</td>
                                                </tr>
                                                <tr>
                                                    <th><span class="fw-medium">Address</span></th>
                                                    <td>{!! $student->applicant->center->address !!}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <table class="table mb-0 table-borderless">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-danger">#{{ $student->applicant->center->id }}</td>
                                                </tr>
                                                <tr>
                                                    <th><span class="fw-medium">Name</span></th>
                                                    <td>{{ $student->applicant->center->name }}</td>
