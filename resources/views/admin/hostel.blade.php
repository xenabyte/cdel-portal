                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="hstack gap-3 fs-15">
                                                <a href="{{ url('admin/viewHostel/'.$hostel->slug) }}" class="link-secondary m-1"><i class= "ri-eye-fill"></i></a>
...
<div id="add" class="modal fade" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" style="display: none;">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content border-0 overflow-hidden">
            ...
            <div class="modal-body">
                <form action="{{ url('/admin/addHostel') }}" method="post" enctype="multipart/form-data">
                    @csrf
