                ...
                <div>
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <p class="text-muted">{{ $student->programme->name }} <br>
                            ...
                            @if(env('WALLET_STATUS'))<hr><a class="dropdown-item" href="#"><i class="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Balance : <b>₦{{ number_format($student->amount_balance/100, 2) }}</b></span></a>@endif
                        </p>
                    ...
                    <div class="acitivity-timeline acitivity-main">
                        ...
                        @if($stage >= 2)
                            <div class="acitivity-item d-flex mb-3">
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-2 ms-2">
                                        - {{ empty($suspension->undertaking_letter) ? 'Guardian letter of undertaking upload is pending' : 'Guardian letter of undertaking uploaded' }}
...
<div id="manageSuspension" class="modal fade" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" style="display: none;">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content border-0 overflow-hidden">
            ...
            <hr>
            <div class="modal-body">
                <form action="{{ url('/admin/manageSuspension') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="suspension_id" value="{{ $suspension->id }}">
