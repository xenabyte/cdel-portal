                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-auto">
                            <div class="hstack gap-1 flex-wrap">
                                ...
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#add">Disable Staff</button>
                                <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#add"> Message</button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content border-0 overflow-hidden">
                                                ...
                                                <div class="modal-body">
                                                    <h4 class="mb-3 mt-4">Are you sure you want to delete <br/> {{ $singleStaffRole->role->role }}?</h4>
