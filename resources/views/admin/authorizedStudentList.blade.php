        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('admin.export-authorized-students', ['courseId' => $courseId, 'programmeCategory' => $programmeCategory->category, 'academicSession' => str_replace('/', '-', $academicSession)]) }}"
