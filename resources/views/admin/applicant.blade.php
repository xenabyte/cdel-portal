                            ...
                            <div class="product-content mt-5">
                                ...
                                <nav>
                                    <ul class="nav nav-tabs nav-tabs-custom nav-info" id="nav-tab" role="tablist">
                                        ...
                                        @if($applicant->application_type != 'UTME')
                                        <li class="nav-item">
                                            <a class="nav-link" id="nav-detail-tab" data-bs-toggle="tab" href="#de" role="tab" aria-controls="nav-detail" aria-selected="false">Direct Entry/Inter University Transfer Result</a>
                                        </li>
                                        @endif
                                    </ul>
                                </nav>
