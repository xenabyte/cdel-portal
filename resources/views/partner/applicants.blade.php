    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Applicants Application Session </h4>
                ...
                <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $applicant->programme?$applicant->programme->name:null }}</td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 overflow-hidden">
            ...
            <div class="modal-body">
                <form action="{{ url('/partner/applicantWithSession') }}" method="post" enctype="multipart/form-data">
                    @csrf
