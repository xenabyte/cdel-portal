...
<div class="col-lg-8">
    <div class="p-lg-5 p-4">
        <div>
            ...
            <p class="text-muted">Sign in to continue to Partner Portal.</p>
        </div>
        ...
        <div class="mt-4">
            <form method="POST" action="{{ url('/partner/login') }}">
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }} mb-3">
                    <div class="float-end">
                        <a href="{{ url('/partner/password/reset') }}" class="text-muted">Forgot password?</a>
                    </div>
        ...
        <div class="mt-5 text-center">
            <p class="mb-0">Don't have an account ? <a href="{{url('/partner/register')}}" class="fw-semibold text-primary text-decoration-underline"> Sign Up</a> </p>
        </div> 
    </div>
</div>
@endsection
