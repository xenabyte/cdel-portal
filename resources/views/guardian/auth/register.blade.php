...
<div class="col-lg-8">
    <div class="p-lg-5 p-4">
        ...
        <div class="mt-4">
            <form method="POST" action="{{ url('/guardian/login') }}">
                @csrf
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }} mb-3">
                    <div class="float-end">
                        <a href="{{ url('/guardian/password/reset') }}" class="text-muted">Forgot password?</a>
                    </div>
        ...
        <div class="mt-5 text-center">
            <p class="mb-0">Don't have an account ? <a href="{{url('/guardian/register')}}" class="fw-semibold text-primary text-decoration-underline"> Signup</a> </p>
        </div>
    </div>
</div>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/guardian/register') }}">
                        {{ csrf_field() }}
