    ...
    <div class="col-xxl-4">
        <div class="card">
            ...
            <div class="card-body pt-0">
                <form action="{{ url('/staff/addRoom') }}" method="post" enctype="multipart/form-data">
                    @csrf
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body text-center p-5">
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <form action="{{ url('/staff/deleteRoom') }}" method="POST">
                                                                @csrf
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body text-center p-5">
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <form action="{{ url('/staff/reserveRoom') }}" method="POST">
                                                                @csrf
                                                                <input name="room_id" type="hidden" value="{{$room->id}}">
                                                                <hr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 overflow-hidden">
            ...
            <div class="modal-body">
                <form action="{{ url('/staff/saveHostel') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="hostel_id" value="{{ $hostel->id }}">
                    <div class="mb-3">
