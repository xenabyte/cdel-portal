            ...
            <div class="card-body p-4">
                <div class="text-center">
                    <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                        <img src="{{ $staff->image }}" class="rounded-circle avatar-xl img-thumbnail user-profile-image  shadow" alt="user-profile-image"> 
                    </div>
                    <h5 class="fs-16 mb-1">{{ $name }}</h5>
                    <p class="text-muted mb-0">{{  $staff->current_position }}</p>
                    <p class="text-muted mb-0 text-bold">Staff ID: {{  $staff->staffId }}</p>
                    <p class="text-muted mb-0 text-bold">Staff Link: <a href="{{  $staff->url }}" target="_blank"> {{  $staff->url }}</a></p>
                </div>
            </div>
        </div>
        <!--end card-->
            ...
            <div class="card-body p-4">
                <div class="tab-content">
                    <div class="tab-pane active" id="personalDetails" role="tabpanel">
                        <form action="{{ url('staff/saveBioData') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <!--end col-->
                                <div class="col-lg-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="title" value="{{$staff->title}}" readonly disabled>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label for="lastname" class="form-label">Last Name</label>
                                        <input type="text" class="form-control" id="lastname" value="{{ $staff->lastname }}" readonly disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="othernames" value="{{$staff->othernames}}" readonly disabled>
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" value="{{$staff->email}}" readonly disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="phone_number" id="phonenumber" value="{{$staff->phone_number}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="religion" id="religion" required>
                                            <option value="" @if($staff->religion == '') selected  @endif >Select Religion</option>
                                            <option @if($staff->religion == 'Christianity') selected  @endif value="Christianity">Christianity</option>
                                            <option @if($staff->religion == 'Islamic') selected  @endif value="Islamic">Islamic</option>
                                            <option @if($staff->religion == 'Others') selected  @endif value="Others">Others</option>
                                        </select>
                                    </div>
                                </div>
                                <!--end col-->
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="gender" id="gender" required>
                                            <option @if($staff->gender == '') selected  @endif value="" selected>Select Gender</option>
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="marital_status" id="marital_status" required>
                                            <option @if($staff->marital_status == '') selected  @endif value="" selected>Select Marital Status</option>
                                            <option @if($staff->marital_status == 'Single') selected  @endif value="Single">Single</option>
                                            <option @if($staff->marital_status == 'Married') selected  @endif value="Married">Married</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label for="nationality" class="form-label">Nationality - {{ $staff->nationality }}</label>
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label for="state_of_origin" class="form-label">State of Origin - {{ $staff->state }}</label>
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label for="lga" class="form-label">Local Government Area - {{ $staff->lga }}</label>
