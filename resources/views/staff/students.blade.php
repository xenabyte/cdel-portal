...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0"> {{ $programmeCategory->category }} Programme Admitted Students for {{ $admissionSession }} Admission Session</h4>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Admitted Students for {{ $admissionSession }} Admission Session </h4>
            </div><!-- end card header -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card-body">
                            ...
                            <form action="{{ url('staff/manageClearanceApplication') }}" method="POST">
                                @csrf
