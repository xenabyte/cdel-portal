                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <div class="mt-2">
                                                                    ...
                                                                    <form action="{{ url('/staff/deleteJobVacancy') }}" method="POST">
                                                                        @csrf
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <div class="modal-content border-0 overflow-hidden">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ url('/staff/updateJobVacancy') }}" method="post" enctype="multipart/form-data">
                                                                    @csrf
...
<div id="add" class="modal fade" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" style="display: none;">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content border-0 overflow-hidden">
            ...
            <div class="modal-body">
                <form action="{{ url('/staff/postJobVacancy') }}" method="post" enctype="multipart/form-data">
                    @csrf
