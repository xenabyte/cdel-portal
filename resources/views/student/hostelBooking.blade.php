                ...
                <div class="text-center">
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            ...
                            <div class="mt-4">
                                <form action="{{ url('/student/generateStudentResultSummary') }}" method="POST">
                                    @csrf
                                    <div class="row g-3">
                    ...
                    <div class="modal-content">
                        <div class="modal-body text-center p-5">
                            ...
                            <div class="mt-2">
                                ...
                                <form action="{{ url('/student/approveResult') }}" method="POST">
                                    @csrf
                                    ...
                                    @endif
                                    <input type="hidden" name="url" value="student.getStudentResultSummary">
                                    <hr>
