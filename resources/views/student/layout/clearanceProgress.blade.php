...
@endphp
<div class="col-xxl-4">
    @if($percent != 100 && empty($student->clearance_status))
    <div class="card">
        <div class="card-body">
    ...
    @elseif(strtolower($student->clearance_status) == 2)
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center mb-5">
                <div class="flex-grow-1">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <br>
                    <form action="{{ url('student/submitClearanceApplication') }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="card-body">
            ...
            <a data-bs-toggle="tab" href="#olevel">
                <div class="alert alert-{{ $olevelResultStatus?'success':'danger' }} shadow" role="alert">
                    <strong>{{ $olevelResultStatus?'Good Job! OLevel Result uploaded successfully':'You are yet to upload your Olevel Result printout' }}</strong>
                </div>
            </a>
