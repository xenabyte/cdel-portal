...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Referred Student(s) {{ $pageGlobalData->sessionSetting->application_session }} application session</h4>
                ...
                <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ !empty($applicant->student)? url('student/student/'.$applicant->student->slug) : url('student/applicant/'.$applicant->slug) }}" class="btn btn-primary m-1"><i class= "ri-user-6-fill"></i> View Applicant/Student</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 overflow-hidden">
            ...
            <div class="modal-body">
                <form action="{{ url('/student/applicantWithSession') }}" method="post" enctype="multipart/form-data">
                    @csrf
