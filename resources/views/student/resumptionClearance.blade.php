    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        <h4 class="mt-4 fw-semibold">Generate Resumption Clearance for {{ $student->academic_session }} Academic Session</h4>
                        <p class="text-muted mt-3"></p>
                        <div class="mt-4">
                            <form action="{{ url('/student/getStudentResumptionClearance') }}" method="POST">
                                @csrf
                                <div class="row g-3">
        ...
        <div class="card">
            <div class="card-header border-0 align-items-center d-flex">
                ...
                <div class="text-end mb-5">
                    <div class="text-end mb-5">
                        <form action="{{ url('/student/generateResumptionClearance') }}" method="POST" target="_blank">
                            @csrf
            ...
            <div class="card-body pb-2 border-top border-top-dashed">
                @php
                    $amountBilled = $studentData->paymentCheck->schoolPayment->structures->sum('amount') ?? 0;
                    $amountPaid = $studentData->paymentCheck->schoolPaymentTransaction->sum('amount_payed') ?? 0;
                                    ...
                                    <table id="buttons-datatables" class="display table table-stripped" style="width:100%">
                                        ...
                                        <tbody>
                                            @php
                                                $id = 1;
                                            @endphp
                                            @foreach($studentData->paymentCheck->schoolPaymentTransaction as $transaction)
                                                <tr>
