...
<head>
    ...
    <meta charset="utf-8" />
    <title>{{ env('APP_NAME') }} || Career Dashboard</title>
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="{{url('career/home')}}" class="logo logo-dark">
                                <span class="logo-sm">
                            ...
                            <a href="{{ url('career/home') }}" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{ !empty($pageGlobalData->setting) ? asset($pageGlobalData->setting->logo) : null }}" alt="" width="50">
                                </span>
                                <span class="logo-lg">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <h6 class="dropdown-header">Welcome {{ $career->lastname.' '.$career->othernames }}!</h6>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{url('/career/profile')}}"><i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Settings</span></a>
                                <a class="dropdown-item" href="{{ url('/career/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
                                <form id="logout-form" action="{{ url('/career/logout') }}" method="POST" style="display: none;">@csrf</form>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ url('/career/home') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ url('career/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
