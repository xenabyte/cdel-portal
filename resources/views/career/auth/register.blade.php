...
<div class="col-lg-8">
    <div class="p-lg-5 p-4">
        ...
        <div class="mt-4">
            <form class="needs-validation" method="POST" novalidate action="{{ url('career/register') }}">
                @csrf
                ...
                <div class="mt-5 text-center">
                    <p class="mb-0">Already have an account? <a href="{{url('/career')}}" class="fw-semibold text-primary text-decoration-underline"> Login here!</a> </p>
                </div>
            </form>
        </div>
        <!-- end card -->
